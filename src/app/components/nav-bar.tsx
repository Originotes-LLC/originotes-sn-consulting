  ...
  return (
    <div className="bg-brand-primary">
          ...
          >
                    ...
                    <div className="grid grid-cols-2 gap-x-4">
                      {category.featured.map((item) => (
                        <div key={item.name} className="group relative text-sm">
                          ...
                          <a
                            href={item.href}
                            className="mt-6 block font-medium text-surface"
                          >
                            <span
                              aria-hidden="true"
            ...
            <div className="space-y-6 border-t border-surface px-4 py-6">
              <div className="flow-root">
                <a href="#" className="-m-2 block p-2 font-medium text-surface">
                  Sign in
                </a>
              </div>
              <div className="flow-root">
      ...
      <header className="relative">
        <p className="flex h-10 items-center justify-center bg-accent px-4 text-sm font-medium text-black sm:px-6 lg:px-8">
            ...
            <div className="flex h-16 items-center">
              ...
              <div className="ml-auto flex items-center">
                <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                  <a
                    href="#"
                    className="text-sm font-medium text-surface hover:text-surface"
                  >
                    Sign in
                  </a>
                ...
                <div className="ml-4 flow-root lg:ml-6">
                  <a href="#" className="group -m-2 flex items-center p-2">
                    ...
                    />
                    <span className="ml-2 text-sm font-medium text-surface group-hover:text-surface">
                      0
                    </span>
